...
function CarouselSerie() {
  ...
  useEffect(() => {
    const getTopAction = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=28&language=pt-BR`,
      }).then((response) => {
  ...
  useEffect(() => {
    const getTop = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=35&language=pt-BR`,
      }).then((response) => {
  ...
  useEffect(() => {
    const getTopR = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=10759&language=pt-BR`,
      }).then((response) => {
  ...
  useEffect(() => {
    const getTopF = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=10765&language=pt-BR`,
      }).then((response) => {
  ...
  useEffect(() => {
    const getTopA = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=16&language=pt-BR`,
      }).then((response) => {
  ...
  useEffect(() => {
    const getTopG = () => {
      axios({
        method: "get",
        url: `https://api.themoviedb.org/3/discover/tv?api_key=e4553f1eb0af7c766ac5a0237ec8baeb&with_genres=10768&language=pt-BR`,
      }).then((response) => {
